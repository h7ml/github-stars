---
project: BoBo-Vue-Admin
stars: 35
description: 😎 vue-cli (4.x) + ts + CrudTable + FormDesigner (开箱即用,企业级开发种子框架,附带表单表格生成器,一键Crud)😎
url: https://github.com/BoBoooooo/BoBo-Vue-Admin
---
...
-   **后端地址可配置**
      ...
      <!-- 服务器地址 -->
      <script\>
        window.\_\_HOST\_\_URL\_\_ = 'http://localhost:3000';
      </script\>
      <!\-- 后端地址 \--\>
      <script\>
        window.\_\_PREFIX\_\_URL\_\_ = '/';
      </script\>
