...
List of clip objects that will be played in sequence. Each clip can have one or more layers.
...
Volume of audio from `clips` relative to `audioTracks`. See audio tracks.
