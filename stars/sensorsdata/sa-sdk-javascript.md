---
project: sa-sdk-javascript
stars: 939
description: 神策数据官方 Web JavaScript 埋点 SDK，是一款轻量级用于 Web 端和 H5 端的数据采集埋点 SDK。使用原生 JavaScript 技术实现代码埋点、全埋点、可视化全埋点、网页热力图和触达图等功能。
url: https://github.com/sensorsdata/sa-sdk-javascript
---
...
如需了解神策埋点 SDK 的更多商业授权信息，请访问神策埋点 SDK 官网获取更多详细信息。
...
使用方法请参考文档 https://manual.sensorsdata.cn/sa/latest/tech\_sdk\_client\_web-7548149.html  
如有疑问请联系邮箱 shengyonggen@sensorsdata.cn  
注意 SDK 可能不完全向前兼容，请查看版本更新说明 CHANGELOG.md ，如果有说明不兼容的话，需要升级神策分析对应的版本
