...
project: DynamicForm
stars: 94
description: antd mobile json form 
url: https://github.com/alitajs/DynamicForm
---
...
方案灵感来源于 ava 的 `autoChart`，用法和触发条件一致，都是 data 为空且在开发状态的时候，显示编辑表单按钮。用户可以强制设定 `isDev` 来在任意环境中使用。
