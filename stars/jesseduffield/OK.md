...
_Try it out on the playground_

_Watch the Making-of video_

_OK?'s mascot: Quentyn Questionmark._

Programming Is Simple Again
---------------------------

_OK?_ is a modern, dynamically typed programming language with a vision for the future. _OK?_'s mission is to do away with the needless complexity of today's programming languages and let you focus on what matters: writing code that makes a difference.
...
accrueYesterdaysYield()

ayy()

hostEnterpriseYellowBorderBackground()
