...
-   2022-05-25 20:20 Update jd\_cleancart.js

```
测试了一下，青龙能跑，我自己的号也能跑，部分号出现JSON问题，佛系修
```

-   2022-02-11 02:10 Update jd\_unsubscribe\_xh.js
...
-   2022-02-03 15:55 Update jd\_try\_xh.js

```
当统一试用组启用时，无论是否已满，第二个账号开始均不会进行试用组的再次添加
```

-   2022-01-30 14:15 Update jd\_try\_xh.js
...
-   2022-01-30 14:10 Update jd\_unsubscribe\_xh.js
...
-   2022-01-30 03:10 Fix jd\_cleancart.js

```
修复了删除失败不会停止的问题
```

-   2022-01-29 22:50 Update jd\_cleancart.js
...
-   2022-01-29 16:45 Fix jd\_unsubscribe\_xh.js
...
-   2022-01-25 16:05 Fix jd\_cleancart.js
...
-   2022-01-25 16:05 Fix jd\_unsubscribe\_xh.js
...
-   2022-01-25 15:42 Fix jd\_try\_xh.js
...
-   2021-12-26 15:00 Fix jd\_unsubscribe\_xh.js

```
修复了获取数据失败的问题
```

-   2021-11-11 13:16 Fix jd\_unsubscribe\_xh.js
...
-   2021-09-14 23:02 Fix jd\_try\_xh.js
...
-   2021-09-14 22:57 Fix jd\_bean\_change\_xh.js

```
修复当环境变量 JD_BEAN_CHANGE_SENDNUM 大于已有账号数会发送多条通知的问题
```

-   2021-09-13 14:15 Fix jd\_try\_xh.js
...
-   2021-09-13 11:32 Fix jd\_ljd\_xh.js

```
修复通知中 [本次执行] 所获取到的成长值计算错误的问题
```

-   2021-09-13 11:22 Fix jd\_try\_xh.js
...
-   2021-09-10 10:24 Fix jd\_try\_xh.js
...
-   2021-09-12 09:09 Fix jd\_ljd\_xh.js
...
-   2021-09-10 12:20 Fix jd\_try\_xh.js

```
更加精确识别出 申请成功但未领取 申请成功已领取 申请已完成 已放弃 的类型
```

-   2021-09-09 21:34 Fix jd\_try\_xh.js
...
-   2021-09-09 13:52 Fix jd\_try\_xh.js
...
-   2021-09-08 17:24 Fix jd\_try\_xh.js
...
-   2021-09-07 12:15 Fix jd\_islogin\_xh.js

```
修复了没有通知的问题
```

-   2021-09-06 22:03 Fix jd\_car\_exchange\_xh.js

```
修复兑换api
```

-   2021-09-06 20:08 Fix jd\_unsubscribe\_xh.js
...
-   2021-09-06 20:08 Fix jd\_try\_xh.js
...
-   2021-09-06 16:47 Fix jd\_try\_xh.js
...
-   2021-09-06 15:58 Fix jd\_try\_xh.js
...
-   2021-09-06 14:20 Fix jd\_try\_xh.js
