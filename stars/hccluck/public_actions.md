---
project: public_actions
stars: 66
description: 掘金定时签到任务 自动发送邮件通知签到结果 邮件 签到 抽奖  沾喜气 自动签到 自动抽奖 自动沾喜气
url: https://github.com/hccluck/public_actions
---

定时任务脚本
------

掘金自动签到 签到后会获得一次免费抽奖机会，自动触发免费抽奖，自动触发沾喜气，自动获取游戏奖励。 执行结束发送邮件通知签到结果。
...
游戏id `控制台执行( window.__NUXT__.state.auth.user.id )获得`
