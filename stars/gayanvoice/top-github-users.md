...
List of most active GitHub users based on `public contributions` `private contributions` and `number of followers` by country or state. The list updated `2025/10/25 1:13 AM UTC`.
...
`Baghdad` `Mosul` `Basra` `Erbil` `Najaf`
...
`Kuala-lumpur` `Malacca-city` `Kuching` `Ipoh` `Johor-bahru`
