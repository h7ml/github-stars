...
You can easily (cross) compile mox yourself. You need a recent Go toolchain installed. Run `go version`, it must be >= 1.22. Download the latest version from https://go.dev/dl/ or see https://go.dev/doc/manage-install.
