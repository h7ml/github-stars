...
> 本库短期内暂时无继续对接tianliGPT的更新计划，请查看最新的 Post-Abstract-AI 项目
...
更多的 Post-Summary-AI 部署效果请查看部署展示
...
**基本配置**如下，更多**进阶**配置项和**实验性**功能，请查看进阶操作
...
2.  若网站开启了**PJAX**，可能会存在切换页面后JS插件无法正常执行的问题，若你不知该如何主动适配，可以将 `pjax` 配置项设为 **true**，具体请查看进阶操作的第 **9** 点。
...
1.  购买完成后，进入管理后台：summary.zhheo.com ，登录后点击右上角的“添加新网站”，输入密钥即可绑定成功。
...
若你的网站接入该项目有困难，可以提 issues，简单讲述你所遇到的困难，并附上**网站地址**，你将会获得快速的回复。
...
这里展示已经成功部署 Post-Summary-AI 的网站，若你已成功部署，可以提 issues，会将你展示于此
