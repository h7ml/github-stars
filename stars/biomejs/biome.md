...
All new developments, fixes and features should be directed towards the `next` branch. The `main` is only used for maintenance and CI while the team prepares everything for v2.
