...
project: leetcode-js
stars: 248
description: 前端数据结构和算法系统练习，冲击一线大厂
url: https://github.com/sanyuan0704/leetcode-js
---
...
另外要介绍的就是本系列的专题系统了，一共会分为这些模块: :::tip 专题目录 **链表篇**、**栈和队列篇**、**哈希表篇**、**二叉树篇**、**字典树**、**并查集**、**常见排序和查找算法**、**回溯算法**、**动态规划**、**贪心算法**、**LRU和LFU**、**字符串和正则篇** ::: 一共十二个模块，相信你会有不错的收获。
