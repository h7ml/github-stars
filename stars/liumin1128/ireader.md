...
project: ireader
stars: 82
description: 基于React实现的可换源电子书阅读器，额，虽然可以看任何小说，但还是要支持正版呀！
url: https://github.com/liumin1128/ireader
---
...
初始化项目，就是上面说的那套开发环境，我已经打包到自用的脚手架工具cat-cli中了，这是一个非常简（chu）单（zhi）易（lan）用（zhao）的脚手架工具，里面都是干货，喜欢的就拿去玩吧。
...
**章节列表 & 章节内容** 获取章节列表和章节内容比较简单，只需稍稍做些异常情况的处理即可。
...
项目中所有数据来自追书神器，非常感谢！！ 本项目仅作用于在实战中学习前端技术，请勿他用。下一步作者或许会做一个音乐播放器？有经验的小伙伴可以一起。github你懂得
