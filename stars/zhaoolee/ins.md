...
开源灵感库已收录143束灵感INS!(～￣▽￣)～更新时间(2025-10-19 06:02:52)
--------------------------------------------------
...
AppleGamingWiki 🟢 126ms  
applegamingwiki.com  
SSL证书到期时间:2025-12-26(剩68天到期)
...
SSL证书到期时间:2025-12-25(剩67天到期)

收集被微软关停的产品

在线工具;信息流;

Stable Diffusion web UI 🟢 527ms  
github.com/AUTOMATIC1111/stabl...  
SSL证书到期时间:2026-02-05(剩110天到期)
...
Squoosh 🟢 143ms  
squoosh.app  
SSL证书到期时间:2026-01-03(剩76天到期)

Google压缩图片工具,支持离线压缩,可以精确调整图片压缩率与图片尺寸,并且可以实时对压缩图与原图进行比较

在线工具;

Crash Course中文字幕组 🟢 976ms  
crashcourse.club  
SSL证书到期时间:2026-01-14(剩87天到期)
...
VPS比价工具 🟢 137ms  
anothervps.com/vps  
SSL证书到期时间:2026-01-01(剩74天到期)

选择各种搜索条件,看看哪个云主机最符合你的需求

极客;

Gym Motivation Music 🟢 126ms  
youtube.com/@gymmotivationmusi...  
SSL证书到期时间:2025-12-15(剩57天到期)
...
菜鸟教程 🟢 947ms  
runoob.com  
SSL证书到期时间:2025-12-05(剩47天到期)

中文互联网最干净实用的图文教程网站

课程;

Rust语言圣经(Rust Course) 🟢 211ms  
course.rs/about-book.html  
SSL证书到期时间:2025-12-09(剩51天到期)
...
SSL证书到期时间:2026-04-14(剩178天到期)

游戏BBS的手机讨论区,水军海军少一些

手机;bbs;

一个更新很快的Mac软件纯种子站 🟢 597ms  
torrentmac.net  
SSL证书到期时间:2025-12-18(剩60天到期)
...
必应壁纸 🟢 683ms  
todaybing.com  
SSL证书到期时间:2025-12-23(剩65天到期)

历史超清必应壁纸下载

壁纸;

GitHub Trending 🟢 1518ms  
github.com/trending  
SSL证书到期时间:2026-02-05(剩110天到期)
...
Photoshop在线免费版 🟢 539ms  
photopea.com  
SSL证书到期时间:2025-12-17(剩59天到期)
