...
在线CDN版本: https://cdn.jsdelivr.net/gh/zhaoolee/ins/website\_info.csv
...
开源灵感库已收录143束灵感INS!(～￣▽￣)～更新时间(2025-08-17 06:03:13)
--------------------------------------------------
...
AppleGamingWiki 🟢 34ms  
applegamingwiki.com  
SSL证书到期时间:2025-10-28(剩72天到期)
...
SSL证书到期时间:2025-10-25(剩69天到期)

收集被微软关停的产品

在线工具;信息流;

Stable Diffusion web UI 🟢 415ms  
github.com/AUTOMATIC1111/stabl...  
SSL证书到期时间:2026-02-05(剩173天到期)
...
Squoosh 🟢 113ms  
squoosh.app  
SSL证书到期时间:2025-11-02(剩77天到期)

Google压缩图片工具,支持离线压缩,可以精确调整图片压缩率与图片尺寸,并且可以实时对压缩图与原图进行比较

在线工具;

Crash Course中文字幕组 🟢 1232ms  
crashcourse.club  
SSL证书到期时间:2025-08-20(剩3天到期)
...
Gym Motivation Music 🟢 97ms  
youtube.com/@gymmotivationmusi...  
SSL证书到期时间:2025-09-29(剩43天到期)
...
菜鸟教程 🟢 1116ms  
runoob.com  
SSL证书到期时间:2025-09-12(剩26天到期)

中文互联网最干净实用的图文教程网站

课程;

Rust语言圣经(Rust Course) 🟢 183ms  
course.rs/about-book.html  
SSL证书到期时间:2025-10-11(剩55天到期)
...
SSL证书到期时间:2026-04-14(剩241天到期)

游戏BBS的手机讨论区,水军海军少一些

手机;bbs;

一个更新很快的Mac软件纯种子站 🟢 652ms  
torrentmac.net  
SSL证书到期时间:2025-10-20(剩64天到期)
...
SkyPixel 🟢 944ms  
skypixel.com  
SSL证书到期时间:2026-05-11(剩267天到期)

专注航拍的摄影网站,世界各地航拍摄影师优秀航拍作品与航拍攻略。

资源集市;信息流;摄影;

Apple iTunes Movie Trailers 🟢 5ms  
trailers.apple.com  
SSL证书到期时间:2025-10-21(剩65天到期)
...
SSL证书到期时间:2025-10-03(剩47天到期)

插画P站最受男性喜欢排行榜资源

小姐姐;每日常逛;

知乎Top1000高票回答 🟢 1092ms  
zhihu.com/topic/19776749/top-a...  
SSL证书到期时间:2026-01-10(剩147天到期)
...
必应壁纸 🟢 138ms  
todaybing.com  
SSL证书到期时间:2025-10-24(剩68天到期)

历史超清必应壁纸下载

壁纸;

GitHub Trending 🟢 866ms  
github.com/trending  
SSL证书到期时间:2026-02-05(剩173天到期)
...
SSL证书到期时间:2025-10-28(剩73天到期)

游戏辅助工具发布

资源集市;

HTML/URL To Markdown 🟢 702ms  
devtool.tech/html-md  
SSL证书到期时间:2025-10-12(剩56天到期)
...
SSL证书到期时间:2025-12-02(剩107天到期)

B站成立以来最具有代表性的作品合集

资源集市;

Photoshop在线免费版 🟢 412ms  
photopea.com  
SSL证书到期时间:2025-10-18(剩62天到期)
