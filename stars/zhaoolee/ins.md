...
开源灵感库已收录143束灵感INS!(～￣▽￣)～更新时间(2025-09-07 06:03:00)
--------------------------------------------------
...
AppleGamingWiki 🟢 85ms  
applegamingwiki.com  
SSL证书到期时间:2025-10-28(剩51天到期)
...
SSL证书到期时间:2025-10-25(剩48天到期)

收集被微软关停的产品

在线工具;信息流;

Stable Diffusion web UI 🟢 542ms  
github.com/AUTOMATIC1111/stabl...  
SSL证书到期时间:2026-02-05(剩152天到期)
...
Squoosh 🟢 89ms  
squoosh.app  
SSL证书到期时间:2025-11-02(剩56天到期)

Google压缩图片工具,支持离线压缩,可以精确调整图片压缩率与图片尺寸,并且可以实时对压缩图与原图进行比较

在线工具;

Crash Course中文字幕组 🟢 764ms  
crashcourse.club  
SSL证书到期时间:2025-11-24(剩78天到期)
...
Gym Motivation Music 🟢 162ms  
youtube.com/@gymmotivationmusi...  
SSL证书到期时间:2025-11-10(剩64天到期)
...
菜鸟教程 🟢 863ms  
runoob.com  
SSL证书到期时间:2025-12-05(剩89天到期)

中文互联网最干净实用的图文教程网站

课程;

Rust语言圣经(Rust Course) 🟢 141ms  
course.rs/about-book.html  
SSL证书到期时间:2025-10-11(剩34天到期)
...
SSL证书到期时间:2026-04-14(剩220天到期)

游戏BBS的手机讨论区,水军海军少一些

手机;bbs;

一个更新很快的Mac软件纯种子站 🟢 562ms  
torrentmac.net  
SSL证书到期时间:2025-10-20(剩43天到期)
...
必应壁纸 🟢 672ms  
todaybing.com  
SSL证书到期时间:2025-10-24(剩47天到期)

历史超清必应壁纸下载

壁纸;

GitHub Trending 🟢 922ms  
github.com/trending  
SSL证书到期时间:2026-02-05(剩152天到期)
...
SSL证书到期时间:2025-10-28(剩52天到期)

游戏辅助工具发布

资源集市;

HTML/URL To Markdown 🟢 603ms  
devtool.tech/html-md  
SSL证书到期时间:2025-10-12(剩35天到期)
...
Photoshop在线免费版 🟢 627ms  
photopea.com  
SSL证书到期时间:2025-10-18(剩41天到期)
