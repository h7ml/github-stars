...
开源灵感库已收录143束灵感INS!(～￣▽￣)～更新时间(2025-08-31 06:03:46)
--------------------------------------------------
...
AppleGamingWiki 🟢 43ms  
applegamingwiki.com  
SSL证书到期时间:2025-10-28(剩58天到期)
...
SSL证书到期时间:2025-10-25(剩55天到期)

收集被微软关停的产品

在线工具;信息流;

Stable Diffusion web UI 🟢 632ms  
github.com/AUTOMATIC1111/stabl...  
SSL证书到期时间:2026-02-05(剩159天到期)
...
Squoosh 🟢 399ms  
squoosh.app  
SSL证书到期时间:2025-11-02(剩63天到期)

Google压缩图片工具,支持离线压缩,可以精确调整图片压缩率与图片尺寸,并且可以实时对压缩图与原图进行比较

在线工具;

Crash Course中文字幕组 🟢 395ms  
crashcourse.club  
SSL证书到期时间:2025-11-24(剩85天到期)
...
菜鸟教程 🟢 726ms  
runoob.com  
SSL证书到期时间:2025-09-12(剩12天到期)

中文互联网最干净实用的图文教程网站

课程;

Rust语言圣经(Rust Course) 🟢 209ms  
course.rs/about-book.html  
SSL证书到期时间:2025-10-11(剩41天到期)
...
SSL证书到期时间:2026-04-14(剩227天到期)

游戏BBS的手机讨论区,水军海军少一些

手机;bbs;

一个更新很快的Mac软件纯种子站 🟢 649ms  
torrentmac.net  
SSL证书到期时间:2025-10-20(剩50天到期)
...
必应壁纸 🟢 157ms  
todaybing.com  
SSL证书到期时间:2025-10-24(剩54天到期)

历史超清必应壁纸下载

壁纸;

GitHub Trending 🟢 685ms  
github.com/trending  
SSL证书到期时间:2026-02-05(剩159天到期)
...
SSL证书到期时间:2025-10-28(剩59天到期)

游戏辅助工具发布

资源集市;

HTML/URL To Markdown 🟢 350ms  
devtool.tech/html-md  
SSL证书到期时间:2025-10-12(剩42天到期)
...
SSL证书到期时间:2025-12-02(剩93天到期)

B站成立以来最具有代表性的作品合集

资源集市;

Photoshop在线免费版 🟢 351ms  
photopea.com  
SSL证书到期时间:2025-10-18(剩48天到期)
