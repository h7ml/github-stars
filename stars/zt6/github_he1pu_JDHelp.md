---
project: github_he1pu_JDHelp
stars: 25
description: null
url: https://github.com/zt6/github_he1pu_JDHelp
---
...
🧧部分红包会过期，记得用，在“京东极速版”或“京喜”APP上搜索“包邮”，不知道买啥选纸巾就完事了...  
互助码不定期清理。  
...
### 自动互助、提交助力码（京喜工厂、种豆得豆、京东工厂、新财富岛、财富岛合珍珠、京东农场、京东健康、东东萌宠、闪购盲盒、5G盲盒、京喜领88元红包、锦鲤红包）  

**上述脚本请尽量改一下默认定时，多运行几次。**  
