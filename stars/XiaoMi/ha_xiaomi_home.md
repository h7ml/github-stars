...
<MIoT-Spec-V2 device instance urn without the version field>:
    ...
    properties: list<service\_iid.property\_iid: str>
    events: list<service\_iid.event\_iid: str>
    actions: list<service\_iid.action\_iid: str>
