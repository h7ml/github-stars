...
-   如果对你有帮助的话，欢迎star
-   demo 演示地址:https://ibwei.github.io/vue3-ts-base/
...
-   支持 tsx 方式编写页面,在.tsx 文件或者 class-component 里写 tsx.
-   支持 class-component 写法.
-   同时支持(.vue|.tsx.|.ts) 编写页面,defineComponent 以及 class-componnet 都支持智能提示.
...
-   基于 axios 封装脱离具体业务逻辑的网络请求,支持编写脱离浏览器环境的测试用例.(跟业务无关)
-   基于具体业务逻辑再次封装网络请求 (跟业务相关,此项需要依据具体后台应用接口编写)

#### 数据状态管理

-   建立应用数据状态管理
-   编写更加简易读取的mutation方法,并完善 type 【新增】
-   支持多个模块,以及自动装载模块
-   支持持久化
