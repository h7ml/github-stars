...
-   通义千问
    ...
    # 填写完善 .env 文件中的内容
    # 通义千问, URL 包含 uri 路径
    TONGYI\_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1"
    # 通义千问的 API\_KEY
    TONGYI\_API\_KEY = ''
    # 通义千问使用的模型
...
-   dify
    ...
    cp .env.example .env
    # 填写完善 .env 文件中的内容
    DIFY\_API\_KEY='你的key'
    # 如果需要私有化部署，请修改.env中下面的配置
    # DIFY\_URL='https://\[你的私有化部署地址\]'
...
-   ollama
    ...
    OLLAMA\_SYSTEM\_MESSAGE='You are a personal assistant.'
