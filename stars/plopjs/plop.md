...
performs the action forcefully (means different things depending on the action)
...
an optional function that can be used to transform the file before writing it to disk
